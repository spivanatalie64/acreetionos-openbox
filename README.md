...
|-------------|-------------|
| `Openbox` | Human-readable edition name (e.g., "XFCE") |
| `OPENBOX` | Short label for ISO volume (e.g., "XFCE") |
| `Openbox Stacking WM Community Edition` | Short description |
| `openbox` | GitHub repo name suffix |
